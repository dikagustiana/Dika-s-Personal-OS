...
import { applyCanonicalEvent, emptyAgentsState, type AgentRecord, type AgentsState, type StreamStats } from '@/core/events/reducer';
import { parseCanonicalEvent } from '@/core/events/schema';
...
const devLog = typeof process !== 'undefined' && process.env.NODE_ENV !== 'production';
