...
import { hexEquals } from '../../../../../logic/floor/hex/hex';
import { activeCampus } from '../../../../../logic/floor/layout/campus';
import { furnitureWorldPose } from '../../../../../logic/floor/layout/resolve';
import type { FurniturePlacement, FurnitureType } from '../../../../../logic/floor/layout/types';
...
export function FurnitureLayer() {
  const byType = useMemo(() => {
    ...
    for (const f of activeCampus().furniture) {
