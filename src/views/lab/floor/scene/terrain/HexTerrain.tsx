...
import { HEX_RADIUS, hexToWorld } from '../../../../../logic/floor/hex/hex';
import { activeCampus, PATH_COLOR, SAND_COLOR } from '../../../../../logic/floor/layout/campus';
import type { TileDef } from '../../../../../logic/floor/layout/types';
...
export function HexTerrain() {
  ...
  const tiles = useMemo(() => Array.from(activeCampus().tiles.values()), []);
  ...
  useLayoutEffect(() => {
    ...
    tiles.forEach((t, i) => {
      ...
      if (t.kind === 'sand') {
        ...
        const zone = t.zoneId ? activeCampus().zoneById.get(t.zoneId) : undefined;
